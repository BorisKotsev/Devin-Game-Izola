...
FIND_PATH(SDL2TTF_INCLUDE_DIR SDL_ttf.h#SDL_ttf.h
	HINTS
	$ENV{SDL2TTFDIR}
...
IF(SDL2TTF_LIBRARY_TEMP)
	...
	SET(SDL2TTF_LIBRARIES ${SDL2TTF_LIBRARY_TEMP} CACHE STRING "Where the SDL2TTF Library can be found")
...
IF(SDL2TTF_LIBRARY_TEMP)
	message(${SDL2TTF_LIBRARY_TEMP})
	SET(SDL2TTF_LIBRARY ${SDL2TTF_LIBRARY_TEMP})
	message(${SDL2TTF_LIBRARY})
ENDIF()

FIND_PACKAGE_HANDLE_STANDARD_ARGS(SDL2TTF REQUIRED_VARS SDL2TTF_INCLUDE_DIR SDL2TTF_LIBRARY)